@extends('layout')
    ...
    @section('title')
        Check in Asset | Asset Management System
    @stop
    ...
    @section('row_1')
      ...
      <div class="box span12">
            	                    <div class="box-header">
                						<h2><i class="icon-signin"></i>Check in Asset</h2>
                						<div class="box-icon">
                					...
                					<div class="box-content">
                						{{ Form::open(array('url'=> 'asset/hardware/checkin/confirm', 'class' => 'form-horizontal')) }}
                                                    						 ...
                                                    						 @if(Session::has('error'))
                                                    							...
                                                    							<div class="control-group">
                                                    							  ...
                                                    							  <div class="controls">
                                                    								<textarea type="text" class="span6" name="notes" id="purpose" required></textarea>
